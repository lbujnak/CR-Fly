...
struct MeshRendererView: View {
    
    static var shared = [
        sceneModelType.alignment: MeshRendererView(modelType: sceneModelType.alignment),
        sceneModelType.preview: MeshRendererView(modelType: sceneModelType.preview),
        sceneModelType.normal: MeshRendererView(modelType: sceneModelType.normal),
        sceneModelType.colorized: MeshRendererView(modelType: sceneModelType.colorized)
    ]
    
    public let modelType: sceneModelType
    
    private let userDisplayScale = true
